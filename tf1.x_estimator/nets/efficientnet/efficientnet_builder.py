...
def get_model_params(model_name, num_classes, override_params):
  ...
  if model_name.startswith('efficientnet'):
    ...
    global_params = efficientnet(
        width_coefficient, depth_coefficient, num_classes, dropout_rate)
  else:
...
def build_model(images,
  ...
  blocks_args, global_params = get_model_params(model_name, num_classes, override_params)
