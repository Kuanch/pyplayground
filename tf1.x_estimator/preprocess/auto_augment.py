...
def sharpness(image, factor):
  ...
  strides = [1, 1, 1, 1]
  # ERROR FIX: UnimplementedError: Depthwise convolution on CPU is only supported for NHWC format
  # This issue might only happen at tf_v1.14
  # Details: https://github.com/tensorflow/tensorflow/issues/22145
